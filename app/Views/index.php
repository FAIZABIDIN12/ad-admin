        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="#services" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:text-white md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
                    </li>
                    <li>
    ...
    <section id="home" class="relative bg-center bg-cover bg-no-repeat bg-[url('/img/bg-asri.png')]">
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-64">
            ...
            <div data-aos="zoom-in" data-aos-duration="1200" class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="https://wa.link/0kc2lc" target="_blank" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-yellow-400 hover:bg-yellow-300 focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-900">
                ...
                <div class="md:flex md:justify-between">
                    ...
                    <div class="max-w-sm">
                        ...
                        <ul class="text-gray-500 text-gray-400 font-medium">
                            <li class="mb-4">
                                <a target="_blank" href="https://wa.link/0kc2lc" class="hover:underline">+628195555184</a>
                            </li>
                            <li>
                                <a href="https://maps.app.goo.gl/MkzpnbKaiZAahqb8A" class="hover:underline" target="_blank">Jl. Veteran No.184 A, Pandeyan, Kec. Umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55161</a>
                            </li>
                        </ul>
                    </div>
